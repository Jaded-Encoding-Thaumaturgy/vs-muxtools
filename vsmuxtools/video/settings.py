...
def settings_builder_5fish_svt_av1_psy(
    ...
    variance_md_bias_thr: float | None = 6.0,
    ...
    **kwargs,
    ...
    These parameters correspond to `ac-bias+exp` branch of the encoder as of early January 2026.
    ...
    :param crf:             Adjust the quality.
                            `15.00 ~ 20.00` is the recommended starting point; About `8.00 ~ 10.00` until `30.00 ~ 32.00` is the recommended range for 5fish/SVT-AV1-PSY.
    ...
    """
    args = {}
    args["_settings_builder_id"] = "SVT-AV1-PSY v2.3.0-B-"
